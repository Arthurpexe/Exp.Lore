...
public class ControladorEquipamento : MonoBehaviour
{
	...
	{
		int slotIndex = (int)newItem.equiparSlot; // estava newItem.Equipar, porem estava dando erro( relacionado ao seu erro de hud provavelmente, dai mudei pra equiparSlot pra n impedir de jogar.
